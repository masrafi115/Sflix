...
public class HorrorAllViewActivity extends  AppCompatActivity  { 
	
	private FirebaseDatabase _firebase = FirebaseDatabase.getInstance();
	
	private ArrayList<HashMap<String, Object>> horror_all_view = new ArrayList<>();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.horror_all_view);
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				DB.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						horror_all_view = new ArrayList<>();
						try {
							GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
							for (DataSnapshot _data : _dataSnapshot.getChildren()) {
								HashMap<String, Object> _map = _data.getValue(_ind);
								horror_all_view.add(_map);
							}
						}
						catch (Exception _e) {
							_e.printStackTrace();
						...
						key.add(_childKey);
						listview1.setAdapter(new Listview1Adapter(horror_all_view));
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.horror_home, null);
			}
			...
			Glide.with(getApplicationContext()).load(Uri.parse(horror_all_view.get((int)_position).get("cover").toString())).into(imageview1);
			linear1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					i.setClass(getApplicationContext(), HomeViewActivity.class);
					i.putExtra("k", key.get((int)(_position)));
					i.putExtra("tag", "Horror");
					startActivity(i);
				}
			});
